  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background:
            "transition-colors duration-700 transition-colors duration-700",
        }}
      />
        ...
        <div className="flex flex-col-reverse items-center justify-between gap-12 pt-7 lg:flex-row">
          <div className="flex-1 text-center lg:text-left">
            ...
            <p className="max-w-2xl mb-8 text-xl leading-relaxed text-gray-600 dark:text-gray-300">
              ...
              enterprise-grade applications using Java, Spring Boot, and React.
              Currently working on scalable payroll and HR systems with secure
              REST APIs.
            </p>
            <div className="flex justify-center gap-5 text-sm md:justify-normal buttons md:text-base">
              ...
              <button
                ...
                aria-label="Contact Alan via email"
          ...
          <div className="flex justify-center flex-1">
            ...
            <div className="w-64 h-64 md:w-80 md:h-80">
              <img
                src={profileImg}
                alt="Alan P J - Full Stack Developer"
                loading="lazy"
