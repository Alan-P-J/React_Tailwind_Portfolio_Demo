...
const PROJECTS = [
  {
    ...
    techStack: ["Java", "Spring Boot", "JPA/Hibernate", "REST APIs", "PostgreSQL", "JWT", "Git", "Postman"],
  ...
  },
  {
    ...
    role: null,
    image: carelinkImg,                 // fixed — was using weatherImg incorrectly
    category: "fullstack",
    features: [
    ...
    techStack: ["Java", "Spring Boot", "React", "PostgreSQL", "JWT", "Git", "Postman"],
...
// ── Badge colour map ──
const BADGE_STYLES = {
  "Work Experience": "bg-blue-100 text-blue-700 dark:bg-blue-900/40 dark:text-blue-300",
  "Personal Project": "bg-gray-100 text-gray-600 dark:bg-gray-700 dark:text-gray-300",
};
...
const Projects = forwardRef((_, ref) => {
  ...
  return (
    <section
      ref={ref}
      id="project"
      className="min-h-screen py-16 transition-colors duration-300 scroll-mt-24 bg-gray-50 dark:bg-gray-900"
    >
          ...
          {displayProjects.map((project) => (
            ...
            >
              ...
              <div className="relative overflow-hidden aspect-video group">
                ...
                />
                <div className="absolute inset-0 transition-opacity duration-300 opacity-0 bg-gradient-to-t from-black/30 to-transparent group-hover:opacity-100" aria-hidden="true" />
