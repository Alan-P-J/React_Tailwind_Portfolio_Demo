  ...
  const projects = [
    {
      ...
      techStack: {
        frontend: [{ name: "React" }, { name: "Spring Boot" },{ name: "REST APIs" },{ name: "SQL" }],
      },
    ...
    },
    {
      ...
      techStack: {
        ...
        backend: [{ name: "Python Flask" },{ name: "Solidity" },{ name: "MYSQL" } ],
      },
...

{
  ...
  date: "Aug 2024",
  description: "A comprehensive task management system with integrated Admin Module that streamlines task assignment, tracking, and management within teams. Enhances productivity, accountability, and timely project delivery through efficient task delegation and monitoring.",
  image: TodoList,
  category: "fullstack",
  features: [
...
const filteredProjects = activeCategory === 'all'
  ...
  const displayProjects = activeCategory === 'all' ? projects.slice(0, 3) : filteredProjects;
