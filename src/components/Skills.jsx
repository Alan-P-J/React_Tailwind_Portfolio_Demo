...
const SKILL_CARD_CLASSES =
  "p-8 transition-all duration-300 transform bg-white shadow-lg dark:bg-gray-800 rounded-2xl hover:-translate-y-2 hover:shadow-xl";
const TECH_TAG_CLASSES =
...
const Skills = memo(
  forwardRef((_, ref) => {
    ...
    return (
      <section
        ref={ref}
        className="py-16 transition-colors duration-300 bg-gray-100 md:pt-28 md:pb-7 dark:bg-gray-900"
      >
        <div className="container px-4 mx-auto">
          ...
          <div className="grid gap-8 md:grid-cols-2">
            {skills.map((skill) => (
              <div key={skill.title} className={SKILL_CARD_CLASSES}>
